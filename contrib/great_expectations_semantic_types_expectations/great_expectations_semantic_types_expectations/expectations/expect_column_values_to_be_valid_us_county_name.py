...
def is_valid_us_county_name(county: str):
...
class ExpectColumnValuesToBeValidUSCountyName(ColumnMapExpectation):
    ...
    examples = [
        {
            ...
            "tests": [
                ...
                },
                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "invalid_county_names"},
                    "out": {"success": False},
                },
            ],
        }
    ...
    map_metric = "column_values.valid_us_county_name"
...
if __name__ == "__main__":
    ExpectColumnValuesToBeValidUSCountyName().print_diagnostic_checklist()
