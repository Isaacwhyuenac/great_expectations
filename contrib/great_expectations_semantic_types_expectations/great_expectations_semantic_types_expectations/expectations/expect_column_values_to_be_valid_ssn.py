...
class ColumnValuesToBeValidSsn(ColumnMapMetricProvider):
    ...
    def _pandas(cls, column, **kwargs):
        def matches_ssn_regex(x):
            return bool(re.match(SSN_REGEX, str(x)))

        return column.apply(lambda x: matches_ssn_regex(x) if x else False)
...
class ExpectColumnValuesToBeValidSsn(ColumnMapExpectation):
    ...
    map_metric = "column_values.valid_ssn"
