...
class ColumnValuesToBeValidDogeAddress(ColumnMapMetricProvider):
    ...
    def _pandas(cls, column, **kwargs):
        return column.apply(lambda x: is_valid_doge_address(x))
...
class ExpectColumnValuesToBeValidDogeAddress(ColumnMapExpectation):
    ...
    examples = [
        {
            "data": {
                "all_valid": [
                    "DAnBU2rLkUgQb1ZLBJd6Bm5pZ45RN4TQC4",
                    "njscgXBB3HUUTXH7njim1Uw82PF9da4R8k",
    ...
    map_metric = "column_values.valid_doge_address"
...
if __name__ == "__main__":
    ExpectColumnValuesToBeValidDogeAddress().print_diagnostic_checklist()
