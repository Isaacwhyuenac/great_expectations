...
def is_valid_south_dakota_zip(zip: str):
    list_of_dicts_of_south_dakota_zips = zipcodes.filter_by(state="SD")
    list_of_south_dakota_zips = [
        d["zip_code"] for d in list_of_dicts_of_south_dakota_zips
    ]
    return len(zip) <= 10 and type(zip) == str and zip in list_of_south_dakota_zips


# This class defines a Metric to support your Expectation.
# For most ColumnMapExpectations, the main business logic for calculation will live in this class.
class ColumnValuesToBeValidSouthDakotaZip(ColumnMapMetricProvider):
...
class ExpectColumnValuesToBeValidSouthDakotaZip(ColumnMapExpectation):
