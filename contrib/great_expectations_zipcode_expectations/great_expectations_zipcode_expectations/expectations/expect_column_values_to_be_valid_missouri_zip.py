...
def is_valid_missouri_zip(zip: str):
    list_of_dicts_of_missouri_zips = zipcodes.filter_by(state="MO")
    list_of_missouri_zips = [d["zip_code"] for d in list_of_dicts_of_missouri_zips]
    return len(zip) <= 10 and type(zip) == str and zip in list_of_missouri_zips


# This class defines a Metric to support your Expectation.
# For most ColumnMapExpectations, the main business logic for calculation will live in this class.
class ColumnValuesToBeValidMissouriZip(ColumnMapMetricProvider):
...
class ExpectColumnValuesToBeValidMissouriZip(ColumnMapExpectation):
